...
const data = [
    {
      ...
      description: "The Major League Baseball (MLB) Players Association, representing Major and Minor League players, coaches, and trainers, faced a digital engagement challenge. Their existing app was functional but not fully meeting the evolving needs of its members",
      imageUrl: "mlb-pic.png",
      caseStudyUrl: "/mlb"
    },
    {
      id: 2,
